...
<style>
    ...
    /* Select2 Custom Styling Overrides to match Modern Indigo */
                    ...
                    <form method="POST" class="form-horizontal" action="{{ route('design-review-b.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="form-group-title">
                                    <i class="fas fa-folder-open me-2 text-indigo"></i> 1. Design Review Reference
                                </div>
                                ...
                                <select class="form-control form-control-modern receiver-select" name="design_review_a_hd_id" required>
                                    ...
                                    @foreach ($hd as $item)
                                        <option value="{{$item->design_review_a_hd_id}}">{{$item->design_review_a_hd_product}} / Model: {{$item->design_review_a_hd_model}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>              
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control form-control-modern" rows="8" name="design_review_b_input" placeholder="กรอกข้อมูลข้อมูลนำเข้าการออกแบบ..." required></textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label-custom text-success">Design Output *</label>
                                <textarea class="form-control form-control-modern" rows="8" name="design_review_b_output" placeholder="กรอกข้อมูลผลลัพธ์การออกแบบ..." required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 mb-2">
                                ...
                                <textarea class="form-control form-control-modern" rows="4" name="design_review_b_remark" placeholder="ระบุหมายเหตุเพิ่มเติม (ถ้ามี)"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                ...
                                <textarea class="form-control form-control-modern" rows="4" name="design_review_b_comment" placeholder="กรอกความคิดเห็นหรือข้อเสนอแนะเพิ่มเติม..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12 d-flex justify-content-end">
                                <button type="submit" class="btn btn-indigo-submit w-100 w-md-auto">
                                    <i class="fas fa-save me-2"></i> บันทึกข้อมูลเอกสารใหม่
                                </button>
                            </div>
                        </div>
                    </form> 
...
$(document).ready(function () {
    // init select2 ให้กับทุกลำดับของ select คลาส .receiver-select
