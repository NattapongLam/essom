            ...
            <form action="{{ route('iso-plan.update', $plan->id) }}" method="POST">
                ...
                <div class="form-section-panel">
                    <div class="row">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <input type="text" name="project_name" value="{{ $plan->project_name }}" class="form-control-modern" required>
                        </div>
                        <div class="col-md-6">
                            <span class="field-label">Responsible Section / Person</span>
                            <input type="text" name="responsible_section" value="{{ $plan->responsible_section }}" class="form-control-modern" required>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-modern text-center" id="activityTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control-modern" name="DA[]" value="{{ $act['description'] ?? '' }}"></td>
                                <td>
                                ...
                                <td><input type="date" class="form-control-modern" name="date_start[]" value="{{ $act['date_start'] ? date('Y-m-d', strtotime($act['date_start'])) : '' }}"></td>
                                <td><input type="date" class="form-control-modern" name="date_end[]" value="{{ $act['date_end'] ? date('Y-m-d', strtotime($act['date_end'])) : '' }}"></td>
                                <td><input type="text" class="form-control-modern" name="RS[]" value="{{ $act['status'] ?? '' }}"></td>
                                <td><input type="text" class="form-control-modern" name="Remark[]" value="{{ $act['remark'] ?? '' }}"></td>
                ...
                <div class="form-section-panel">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4 mb-3 mb-md-0">
                            ...
                            <input class="form-control-modern" type="text" name="prepared_by" value="{{ $plan->prepared_by }}" readonly>
                        </div>
                        <div class="col-md-2 mb-3 mb-md-0">
                            <span class="field-label">Date</span>
                            <input class="form-control-modern" type="date" name="prepared_date" value="{{ $plan->prepared_date ? date('Y-m-d', strtotime($plan->prepared_date)) : '' }}" required>
                        </div>
                        <div class="col-md-4 mb-3 mb-md-0">
                         ...
                         <div class="col-md-2">
                            <span class="field-label">Date</span>
                            <input class="form-control-modern" type="date" name="prepared_progress_date" value="{{ $plan->prepared_progress_date ? date('Y-m-d', strtotime($plan->prepared_progress_date)) : '' }}" required>
                         </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 mb-3 mb-md-0">
                            <span class="field-label">Date</span>
                            <input class="form-control-modern" type="date" name="reviewed_date" value="{{ $plan->reviewed_date ? date('Y-m-d', strtotime($plan->reviewed_date)) : '' }}" required>
                        </div>
                        <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <div class="col-md-2">
                            <span class="field-label">Date</span>
                            <input class="form-control-modern" type="date" name="reported_date" value="{{ $plan->reported_date ? date('Y-m-d', strtotime($plan->reported_date)) : '' }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-3 mb-md-0">
                            <span class="field-label">Date</span>
                            <input class="form-control-modern" type="date" name="approved_date" value="{{ $plan->approved_date ? date('Y-m-d', strtotime($plan->approved_date)) : '' }}" required>
                        </div>
                        <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <div class="col-md-2">
                            <span class="field-label">Date</span>
                            <input class="form-control-modern" type="date" name="acknowledged_date" value="{{ $plan->acknowledged_date ? date('Y-m-d', strtotime($plan->acknowledged_date)) : '' }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-right style-action-container" style="margin-top:20px;">
                    <button type="submit" class="btn-indigo-submit">
                        <i class="fas fa-save mr-1"></i> อัปเดตข้อมูลแผนงาน
                    </button>
                </div>
            </form>                 
        </div>
