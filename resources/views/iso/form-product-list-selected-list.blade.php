    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-center">
                ...
                <p class="text-left">
                    <a href="{{route('product-list-selected.create')}}">เพิ่มเอกสาร</a>
                </p>              
            </div>
            <div class="card-body">             
                <div class="table-responsive">
                    <table id="tb_job" class="table table-bordered table-sm text-center">
                        ...
                        <tbody>
                            @foreach ($hd as $item)
                                <tr>
                                    <td>{{$item->product_list_selected_hd_product}}</td>
                                    <td>
                                        <a href="{{route('product-list-selected.edit',$item->product_list_selected_hd_id)}}" class="btn btn-sm btn-warning" >
