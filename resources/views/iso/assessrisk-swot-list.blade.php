                            ...
                            <table id="swotTable" class="table table-bordered table-sm text-center">
                                ...
                                <tbody>
                                    @foreach($records as $record)
                                                                    <?php 
                                                                             if ($record->strength != null && $record->weakness != null && $record->opportunity != null && $record->weakness != null && $record->threat != null) {
                                                                            ?>


                                                                    <tr>
                                                                        <td>{{ $record->meeting_date ? \Carbon\Carbon::parse($record->meeting_date)->format('Y-m-d') : '' }}
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ route('assessrisk-swot.edit', $record->id) }}"
