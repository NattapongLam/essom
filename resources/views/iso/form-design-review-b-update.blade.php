            ...
            <div class="card custom-card">
                ...
                <div class="card-body p-4 p-md-5">   
                    <form method="POST" class="form-horizontal" action="{{ route('design-review-b.update',$hd->design_review_b_id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="form-group-title">
                                    <i class="fas fa-file-signature me-2 text-indigo"></i> 1. Design Review Reference
                                </div>
                                <input type="hidden" name="docuref" value="Update">
                                <label class="form-label-custom">เอกสารอ้างอิง (Product / Model)</label>
                        ...
                        <div class="row p-3 mb-4 mx-0 rounded-3 workflow-card">
                            ...
                            {{-- Condition Check Workflow Status --}}
                            @if ($hd->reviewed_status == "Y")
                                <div class="col-md-9 mb-3">
                                    <label class="form-label-custom text-muted">Reviewed By (ผ่านการทบทวนแล้ว)</label>
                                ...
                                <div class="col-md-9 mb-3">
                                    <label class="form-label-custom text-indigo font-weight-bold">
                                        <span class="badge workflow-badge-active me-1">Active Step</span> Engineering Supervisor (ผู้อนุมัติ)
                                    </label>
                                    <input class="form-control form-control-modern" style="border-color:#6366f1; background-color:#fff;" type="text" name="engineecing_by" value="{{auth()->user()->name}}" readonly>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label-custom text-indigo">Date</label>
                                    <input class="form-control form-control-modern" style="border-color:#6366f1; background-color:#fff;" type="date" name="engineecing_date" value="{{ old('date', now()->format('Y-m-d')) }}">
                                </div>
                            ...
                            @else
                                <div class="col-md-9 mb-3">
                                    <label class="form-label-custom text-indigo font-weight-bold">
                                        <span class="badge workflow-badge-active me-1">Active Step</span> Reviewed By (ผู้ทบทวน)
                                    </label>
                                    <input class="form-control form-control-modern" style="border-color:#6366f1; background-color:#fff;" type="text" name="reviewed_by" value="{{auth()->user()->name}}" readonly>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label-custom text-indigo">Date</label>
                                    <input class="form-control form-control-modern" style="border-color:#6366f1; background-color:#fff;" type="date" name="reviewed_date" value="{{ old('date', now()->format('Y-m-d')) }}">
                                </div>
                                    
                                <div class="col-md-9 mb-3">
                                    <label class="form-label-custom text-muted">Engineering Supervisor (ผู้อนุมัติลำดับถัดไป)</label>
                                    <input class="form-control form-control-modern" type="text" name="engineecing_by" placeholder="รอการทบทวนเอกสาร" readonly>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label-custom text-muted">Date</label>
                        ...
                        <div class="row mt-4">
                            <div class="col-12 d-flex justify-content-end">
                                <button type="submit" class="btn btn-indigo-submit w-100 w-md-auto">
                                    <i class="fas fa-check-circle me-2"></i> บันทึกและดำเนินการต่อ
                                </button>
                            </div>
                        </div>
                    </form> 
