            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <div class="col-8">
                        ...
                        <input class="form-control" type="text" name="checked_by" value="{{$hd->checked_by}}" readonly>
                    </div>
                    <div class="col-4">
                        <label>Date</label>
                        <input class="form-control" type="date" name="checked_date" value="{{$hd->checked_date}}" readonly>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">
                        <label>5. Senior Engineer Comments</label>
                        <textarea class="form-control" rows="5" name="detailed_testings_comments"></textarea>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-8">
                        <label>Signature</label>
                        <input class="form-control" type="text" name="signature_by" value="{{auth()->user()->name}}" readonly>
                    </div>
                    <div class="col-4">
                        <label>Date</label>
                        <input class="form-control" type="date" name="signature_date" value="{{ old('date', now()->format('Y-m-d')) }}" >
                    </div>
                </div>
                @else
                <div class="row mt-3">
                    <div class="col-8">
                        <label>4. Checked by</label>
                        <input class="form-control" type="text" name="checked_by" value="{{auth()->user()->name}}" readonly>
                    </div>
                    <div class="col-4">
                        <label>Date</label>
                        <input class="form-control" type="date" name="checked_date" value="{{ old('date', now()->format('Y-m-d')) }}">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">
