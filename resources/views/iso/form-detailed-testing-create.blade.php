...
<div class="row">  
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" class="form-horizontal" action="{{ route('detailed-testing.store') }}" enctype="multipart/form-data">
                @csrf                 
                <div class="row mt-3">
                    <div class="col-4">
                        <label>1. Product</label>
                        <input class="form-control" type="text" name="detailed_testings_product" required>
                    </div>
                    <div class="col-4">
                        <label>Code</label>
                        <input class="form-control" type="text" name="detailed_testings_code" required>
                    </div>
                    <div class="col-4">
                        <label>S/N</label>
                        <input class="form-control" type="text" name="detailed_testings_serial">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-8">
                    ...
                    <div class="col-4">
                        <label>Date</label>
                        <input class="form-control" type="date" name="tested_date" value="{{ old('date', now()->format('Y-m-d')) }}">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-4">
                        <label>3. Test data per attached (Page)</label>
                        <input class="form-control" type="text" name="detailed_testings_testdata">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">
                        <label>3.1 Data</label>
                        <textarea class="form-control" rows="10" name="detailed_testings_data" required></textarea>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-3">
