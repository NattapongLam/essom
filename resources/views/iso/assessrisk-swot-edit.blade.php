...
td input:focus { border-color:#000; outline:none; background-color:#eef2ff; }
button, .primary { background-color:#1e40af; color:white; border:none; padding:8px 16px; font-size:14px; border-radius:6px; cursor:pointer; transition:0.2s; }
button:hover, .primary:hover { background-color:#1d4ed8; }
button.deleteRow { background-color:#dc2626; padding:4px 10px; }
...
.white-btn { background:white; color:#1e3a8a; border:1px solid #1e3a8a; padding:6px 16px; border-radius:6px; font-weight:600; cursor:pointer; transition:0.2s; }
.white-btn:hover { background:#1e3a8a; color:white; }
.step { display:none; }
...
@csrf
@method('PUT')
<h3>แก้ไขแบบฟอร์มการวิเคราะห์ความเสี่ยงต่อธุรกิจของบริษัท</h3>

<div id="step1" class="step active">
<div class="form-header">
    <div class="description">ารวิเคราะห์ความเสี่ยงด้านปัจจัยภายใน และภายนอก ที่มีผลต่อกลยุทธ์ของบริษัท ด้วย SWOT Analysis</div>
    <div class="meeting-date">
        <label>วันที่ประชุม:</label>
        <input type="date" name="meeting_date" value="{{ $record->meeting_date?->format('Y-m-d') }}">
    </div>
</div>
...
<tr>
<td><input type="text" name="strength_risk[]" value="{{ $s['risk'] }}"></td>
<td><input type="text" name="strength_accept[]" value="{{ $s['accept'] }}"></td>
<td><input type="text" name="strength_non_accept[]" value="{{ $s['non_accept'] }}"></td>
<td><input type="text" name="strength_measure[]" value="{{ $s['measure'] }}"></td>
<td><input type="text" name="strength_activity[]" value="{{ $s['activity'] }}"></td>
<td><input type="text" name="strength_responsible[]" value="{{ $s['responsible'] }}"></td>
<td><input type="text" name="strength_review_non_accept[]" value="{{ $s['review_non_accept'] }}"></td>
<td><input type="text" name="strength_review_accept[]" value="{{ $s['review_accept'] }}"></td>
...
<tr>
<td><input type="text" name="weakness_risk[]" value="{{ $w['risk'] }}"></td>
<td><input type="text" name="weakness_accept[]" value="{{ $w['accept'] }}"></td>
<td><input type="text" name="weakness_non_accept[]" value="{{ $w['non_accept'] }}"></td>
<td><input type="text" name="weakness_measure[]" value="{{ $w['measure'] }}"></td>
<td><input type="text" name="weakness_activity[]" value="{{ $w['activity'] }}"></td>
<td><input type="text" name="weakness_responsible[]" value="{{ $w['responsible'] }}"></td>
<td><input type="text" name="weakness_review_non_accept[]" value="{{ $w['review_non_accept'] }}"></td>
<td><input type="text" name="weakness_review_accept[]" value="{{ $w['review_accept'] }}"></td>
<td><button type="button" class="deleteRow">ลบ</button></td>
</tr>
@empty
<tr><td colspan="9"><input type="text" name="weakness_risk[]"></td></tr>
@endforelse
</tbody>
</table>
...
<tr>
<td><input type="text" name="opportunity_risk[]" value="{{ $o['risk'] }}"></td>
<td><input type="text" name="opportunity_accept[]" value="{{ $o['accept'] }}"></td>
<td><input type="text" name="opportunity_non_accept[]" value="{{ $o['non_accept'] }}"></td>
<td><input type="text" name="opportunity_measure[]" value="{{ $o['measure'] }}"></td>
<td><input type="text" name="opportunity_activity[]" value="{{ $o['activity'] }}"></td>
<td><input type="text" name="opportunity_responsible[]" value="{{ $o['responsible'] }}"></td>
<td><input type="text" name="opportunity_review_non_accept[]" value="{{ $o['review_non_accept'] }}"></td>
<td><input type="text" name="opportunity_review_accept[]" value="{{ $o['review_accept'] }}"></td>
<td><button type="button" class="deleteRow">ลบ</button></td>
</tr>
@empty
<tr><td colspan="9"><input type="text" name="opportunity_risk[]"></td></tr>
@endforelse
</tbody>
</table>
...
<tr>
<td><input type="text" name="threat_risk[]" value="{{ $t['risk'] }}"></td>
<td><input type="text" name="threat_accept[]" value="{{ $t['accept'] }}"></td>
<td><input type="text" name="threat_non_accept[]" value="{{ $t['non_accept'] }}"></td>
<td><input type="text" name="threat_measure[]" value="{{ $t['measure'] }}"></td>
<td><input type="text" name="threat_activity[]" value="{{ $t['activity'] }}"></td>
<td><input type="text" name="threat_responsible[]" value="{{ $t['responsible'] }}"></td>
<td><input type="text" name="threat_review_non_accept[]" value="{{ $t['review_non_accept'] }}"></td>
<td><input type="text" name="threat_review_accept[]" value="{{ $t['review_accept'] }}"></td>
<td><button type="button" class="deleteRow">ลบ</button></td>
</tr>
@empty
<tr><td colspan="9"><input type="text" name="threat_risk[]"></td></tr>
@endforelse
</tbody>
</table>
...
<div class="report-section">
    ...
    <div class="report-item">
        <label>วันที่</label>
        <input type="date" name="report_date" value="{{ $record->report_date?->format('Y-m-d') }}">
    </div>
    <div class="report-item">
    ...
    <div class="report-item">
        <label>วันที่</label>
        <input type="date" name="ack_date" value="{{ $record->ack_date?->format('Y-m-d') }}">
    </div>
</div>
</div>
