    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-center">
                ...
                <p class="text-left">
                    <a href="{{route('design-edit.create')}}">เพิ่มเอกสาร</a>
                </p>              
            </div>
            <div class="card-body">             
                <div class="table-responsive">
                    <table id="tb_job" class="table table-bordered table-sm text-center">
                        ...
                        <tbody>    
                            @foreach ($hd as $item)
                                <tr>
                                    <td>{{ $item->design_edits_product}}</td>
                                    <td>{{ $item->design_edits_model}}</td>
                                    ...
                                    <td>
                                        <a href="{{route('design-edit.show',$item->design_edits_id)}}" class="btn btn-sm btn-primary" >
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0)" class="btn btn-danger btn-sm"  
                                            onclick="confirmDel('{{ $item->design_edits_id }}')">
