                ...
                <div class="table-responsive">
                    <table id="tb_job" class="table table-bordered table-sm text-center">
                        ...
                        <tbody>
                            @foreach ($hd as $item)
                                <tr>
                                    <td>{{$item->recipient_selection_hd_name}}</td>
                                    <td>{{$item->recipient_selection_hd_contact}}</td>
                                    <td>{{$item->recipient_selection_hd_tel}}</td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{route('recipient-selection.edit',$item->recipient_selection_hd_id)}}" class="btn btn-sm btn-info" >
                                    ...
                                    <td>
                                        <a href="{{route('recipient-selection.show',$item->recipient_selection_hd_id)}}" class="btn btn-sm btn-primary" >
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </td>
                                    <td>
