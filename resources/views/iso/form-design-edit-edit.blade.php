...
<style>
    ...
    /* Custom File Input Container & Badge */
    .custom-file-upload {
        ...
        <div class="col-xl-10 col-12">
            <div class="card custom-card">
                <div class="card-header custom-card-header">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                        <div class="text-center text-md-left mb-3 mb-md-0">
                            ...
                            <span class="subtitle-badge"><i class="fas fa-edit mr-2"></i>แก้ไขคำขอแก้ไขแบบ &bull; EDIT DESIGN CHANGE REQUEST</span>
                        </div>
                ...
                <div class="card-body p-4 p-md-5">   
                    <form method="POST" action="{{ route('design-edit.update', $hd->design_edits_id) }}" enctype="multipart/form-data">
                        @csrf 
                        @method('PUT')                                      
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 form-group mb-4">
                                <label for="design_edits_file">อัปโหลดไฟล์แนบใหม่ (อัปโหลดเมื่อต้องการเปลี่ยนไฟล์)</label>
                                <div class="custom-file-upload mb-2">
                                    <input type="file" class="form-control-file" id="design_edits_file" name="design_edits_file">
                                </div>
                            </div>
                            <div class="col-md-6 col-12 form-group mb-4 d-flex align-items-end pb-2">
                                @if ($hd->design_edits_file)
                                    <div>
                                        <label class="d-block text-muted">ไฟล์แนบปัจจุบัน</label>
                                        <a href="{{ asset($hd->design_edits_file) }}" target="_blank" class="btn-current-file">
                                            <i class="fas fa-file-download mr-2"></i> เปิดดูไฟล์แนบเดิม
                                        </a>
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12 form-group mb-4">
                                ...
                                <input class="form-control form-control-modern" type="date" name="supervisor_date" value="{{ $hd->supervisor_date }}" required>
                            </div>
                        </div>

                        <div class="form-section-title mt-4 text-muted">4. Review Process (Read-Only)</div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12 text-md-right text-center">
                                <button type="submit" class="btn btn-indigo-submit px-5">
                                    <i class="fas fa-save mr-2"></i> อัปเดตข้อมูลคำขอ
                                </button>
                            </div>
                        </div>
                    </form> 
