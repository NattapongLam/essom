...
<div class="form-container">
    ...
    <table id="objectiveTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input type="text" name="resp_person[]" value="{{ old('resp_person.'.$i, $act['resp_person']) }}"></td>
    ...
    <div class="section-line">
        <label>Prepared by:
            <input type="text" name="prepared_by" value="{{ old('prepared_by', $objcctive->prepared_by) }}" style="width:300px;" required>
        </label>
        <label>Date:
            <input type="date" name="prepared_date" value="{{ old('prepared_date', optional(\Carbon\Carbon::parse($objcctive->prepared_date))->format('Y-m-d')) }}">
        </label>
        <label>Reported by:
            <input type="text" name="reported_by" value="{{ old('reported_by', $objcctive->reported_by) }}" style="width:300px;" required>
        </label>
        <label>Date:
            <input type="date" name="reported_date" value="{{ old('reported_date', optional(\Carbon\Carbon::parse($objcctive->reported_date))->format('Y-m-d')) }}">
        </label>
    </div>
    <br>
    <div class="section-line">
        <label>Reviewed by:
            <input type="text" name="reviewed_by" value="{{ old('reviewed_by', $objcctive->reviewed_by) }}" style="width:308px;" required>
        </label>
        <label>Date:
            <input type="date" name="reviewed_date" value="{{ old('reviewed_date', optional(\Carbon\Carbon::parse($objcctive->reviewed_date))->format('Y-m-d')) }}">
        </label>
        <label>Acknowledged by:
            <input type="text" name="acknowledged_by" value="{{ old('acknowledged_by', $objcctive->acknowledged_by) }}" style="width:263px;" required>
        </label>
        <label>Date:
            <input type="date" name="acknowledged_date" value="{{ old('acknowledged_date', optional(\Carbon\Carbon::parse($objcctive->acknowledged_date))->format('Y-m-d')) }}">
        </label>
    </div>
    <br>
    <div class="section-line">
        <label>Approved by:
            <input type="text" name="approved_by" value="{{ old('approved_by', $objcctive->approved_by) }}" style="width:302px;" required>
        </label>
        <label>Date:
            <input type="date" name="approved_date" value="{{ old('approved_date', optional(\Carbon\Carbon::parse($objcctive->approved_date))->format('Y-m-d')) }} style="width:200px;">
        </label>
    </div>
