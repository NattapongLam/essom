...
<div class="form-container">
    ...
    <div class="section-title-container">
        ...
        <div class="date-inline">
            ...
            <input type="date" name="design_request_date" id="design_request_date"
                   value="{{ $plan->design_request_date }}">
        </div>
    </div>
    ...
    <div><label>2.1 Engineer</label><input type="text" name="engineer_desing" value="{{ $plan->engineer_desing }}" placeholder="Engineer"></div>
    <div><label>2.2 seniorEngineer</label><input type="text" name="senior_engineer" value="{{ $plan->senior_engineer }}" placeholder="seniorEngineer"></div>
    <div class="row">
        ...
        <div class="row">
            ...
            @if (count($fields) === 1)
                <div style="grid-column: span 2; width: 100%;">
                    <input type="text" name="{{ $fields[0] }}" value="{{ $plan->{$fields[0]} }}" placeholder="Participants">
                </div>
            @else
                <div><input type="date" name="{{ $fields[0] }}" value="{{ $plan->{$fields[0]} }}"></div>
                <div><input type="date" name="{{ $fields[1] }}" value="{{ $plan->{$fields[1]} }}"></div>
            @endif
        </div>
    @endforeach
